...
parentHeadersLength = len(parentHeaders) + 1

currentDataFrame = dataframe.iloc[1:, firstHeader:parentHeadersLength]

for i in range(0, len(currentDataFrame.iloc[0:])-4):
    ...
    childData.append({"t_name_code": teacherCode, "c_name_code": nameCode, "age": age, "gender": gender, "special_need": special_need})
